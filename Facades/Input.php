 ...
 * @method static \IgniteKit\Backports\Http\UploadedFile|\IgniteKit\Backports\Http\UploadedFile[]|array|null file(string|null $key = null, mixed $default = null)
 * @method static \IgniteKit\Backports\Http\Request capture()
 ...
 * @method static \IgniteKit\Backports\Http\Request createFrom(\IgniteKit\Backports\Http\Request $from, \IgniteKit\Backports\Http\Request|null $to = null)
 * @method static \IgniteKit\Backports\Http\Request createFromBase(\Symfony\Component\HttpFoundation\Request $request)
 * @method static \IgniteKit\Backports\Http\Request duplicate(array|null $query = null, array|null $request = null, array|null $attributes = null, array|null $cookies = null, array|null $files = null, array|null $server = null)
 ...
 * @method static \IgniteKit\Backports\Routing\Route|object|string route(string|null $param = null, string|null $default = null)
