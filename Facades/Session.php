 ...
 * @method static void setRequestOnHandler(\IgniteKit\Backports\Http\Request $request)
 *
 * @see \IgniteKit\Backports\Session\SessionManager
 * @see \IgniteKit\Backports\Session\Store
 */
