...
use IgniteKit\Backports\Contracts\Mail\Mailer;
use IgniteKit\Backports\Contracts\Mail\Mailable;
use IgniteKit\Backports\Contracts\Mail\MailQueue;
use PHPUnit\Framework\Assert as PHPUnit;
use IgniteKit\Backports\Contracts\Queue\ShouldQueue;
...
class MailFake implements Mailer, MailQueue
{
     ...
     *
     * @param  mixed  $users
     * @return \IgniteKit\Backports\Mail\PendingMail
     */
     ...
     * @param  string|array|\IgniteKit\Backports\Contracts\Mail\Mailable  $view
     * @param  string  $queue
     * @return mixed
     */
